...
public enum ErrorType {
    ...
    COMPANY_NOT_APPROVED(1032, "The Assembly is not approved. You are not allowed to take an action!", UNAUTHORIZED),
    ...
    ASSEMBLY_LINK_ALREADY_EXISTS(1040, "The Assembly already exist", NOT_ACCEPTABLE),
